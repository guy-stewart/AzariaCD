...
delete from objects where object = 'IDD_SEED';
delete from spr_names where name = 'IDS_SEED';
insert into objects values
('IDD_SEED','16012','IDD_NULL','0','SEED','SEED','SEED');
...
('M10_FLOWER','30','0','WAIT','','', '
    ...
    SHOW(0,IDS_FLOPN1);
    ANIMATE(0,V_REVERSE);'),
('M10_FLOWER','30','30','GRAB','','IDD_SEED','');
