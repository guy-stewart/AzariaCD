...
(0,'S_SHEEP_PEN1',0,'IDV_VIL4',44,150,124,213,0,'M_ANIMALPEN','IDS_SHEEPQ', 'IDS_SHEEPR', 'IDS_SHEEPQ', 'IDS_SHEEPRB',0,'IDD_SHEEP_I','');
...
('M_ANIMALPEN','idle','captured','DROP','IDD_ROOTBLUE','','
    PLAYWAVE(SOUND_BAA);
    SHOW(0);
    HANDOFF(0,WIP5);
','',''),
('M_ANIMALPEN','captured','idle','DROP','WIP5','',
'STOPWAVE();
ASHOW(WIP1);','',''),
...
'PLAYWAVE(SOUND_BAA);
 ASHOW(WIP2);','',''),
('M_PESTER','rightidle','captured','DROP','IDD_ROOTBLUE','','
    PLAYWAVE(SOUND_BAA);
    SHOW(0);
    HANDOFF(0,IDD_SHEEP_I);
','',''),
('M_PESTER','startled','leftidle','MOVETO','mark2','4000',
'STOPWAVE();
 ASHOW(WIP3);','',''),
...
PLAYWAVE(SOUND_GALLOP);
 ASHOW(WIP4);','',''),
('M_PESTER','leftidle','captured','DROP','IDD_ROOTBLUE','','
    PLAYWAVE(SOUND_BAA);
    SHOW(0);
    HANDOFF(0,IDD_SHEEP_I);
','',''),
('M_PESTER','captured','rightidle','DROP','IDD_SHEEP_I','','
    ASHOW(WIP1);
','',''),
('M_PESTER','runback','rightidle','MOVETO','mark1','2500',
'STOPWAVE();
ASHOW(WIP1);','','');
