...
insert into cardinals values (IDV_ctya,IDV_ctyd,NULL,IDV_ctyc,NULL,NULL,NULL,IDV_ctyb,IDV_ctye);
...
insert into cardinals values (IDV_SCN10PT0,IDV_SCN10PIT,NULL,NULL,IDV_GRNDCNT1,NULL,NULL,NULL,NULL);
insert into cardinals values (IDV_FA1PAN,NULL,NULL,NULL,IDV_FH1PTH1,NULL,NULL,IDV_GRNDCNT1,NULL);
insert into cardinals values (IDV_FH1PTH1,NULL,NULL,IDV_FH1PTH2,IDV_FH1PTH2,NULL,NULL,IDV_FA1PAN,IDV_FA1PAN);
insert into cardinals values (IDV_FH1PTH2,NULL,NULL,IDV_FH1PAN,NULL,NULL,NULL,IDV_FH1PTH1,NULL);
insert into cardinals values (IDV_FH1PAN,NULL,NULL,NULL,NULL,NULL,NULL,IDV_FH1PTH2,NULL);
insert into cardinals values (IDV_TM1PAN,NULL,IDV_TM5PAN,NULL,NULL,NULL,NULL,NULL,IDV_TM2PAN);
insert into cardinals values (IDV_TM2PAN,IDV_TM3PAN,IDV_TM4PAN,IDV_TM5PAN,NULL,IDV_TM1PAN,NULL,IDV_TMCU1,NULL);
insert into cardinals values (IDV_TM3PAN,NULL,IDV_TMCUT,IDV_TM4PAN,IDV_TM5PAN,IDV_TM2PAN,NULL,IDV_TMCU2,NULL);
insert into cardinals values (IDV_TM4PAN,NULL,NULL,IDV_TMCU3,NULL,IDV_TM5PAN,IDV_TM2PAN,IDV_TM3PAN,IDV_TMCUT);
insert into cardinals values (IDV_TM5PAN,IDV_TM4PAN,NULL,IDV_TMCU4,NULL,IDV_TM1PAN,NULL,IDV_TM2PAN,IDV_TM3PAN);
insert into cardinals values (IDV_VIL2,NULL,NULL,NULL,NULL,NULL,NULL,IDV_VIL3,NULL);
insert into cardinals values (IDV_VIL3,NULL,NULL,IDV_VIL2,NULL,NULL,NULL,IDV_VIL4,NULL);
insert into cardinals values (IDV_VIL4,NULL,NULL,IDV_VIL3,NULL,NULL,NULL,IDV_VIL5,NULL);
insert into cardinals values (IDV_VIL5,NULL,NULL,IDV_VIL4,NULL,NULL,NULL,IDV_VIL6,NULL);
insert into cardinals values (IDV_VIL6,NULL,NULL,IDV_VIL5,NULL,NULL,NULL,IDV_VIL7,NULL);
insert into cardinals values (IDV_VIL7,NULL,NULL,IDV_VIL6,NULL,NULL,NULL,IDV_VIL8,IDV_VIL9);
insert into cardinals values (IDV_VIL8,IDV_VIL9,NULL,IDV_VIL7,NULL,NULL,NULL,NULL,NULL);
insert into cardinals values (IDV_VIL9,IDV_VILA,NULL,NULL,IDV_VIL7,IDV_VIL8,NULL,NULL,NULL);
insert into cardinals values (IDV_VILA,IDV_VILB,NULL,NULL,NULL,IDV_VIL9,NULL,NULL,NULL);
insert into cardinals values (IDV_VILB,NULL,IDV_VILE,IDV_VILD,NULL,IDV_VILA,NULL,IDV_VILC,NULL);
insert into cardinals values (IDV_VILC,NULL,NULL,IDV_VILB,NULL,NULL,NULL,IDV_VILG,NULL);
insert into cardinals values (IDV_VILD,IDV_VILE,NULL,IDV_VILB,NULL,NULL,NULL,IDV_VILH,NULL);
insert into cardinals values (IDV_VILE,NULL,NULL,NULL,NULL,NULL,IDV_VILB,NULL,NULL);
...
insert into cardinals values (IDV_TMPLPTH1,IDV_TMPLPTH2,IDV_TMPLPTH2,NULL,NULL,NULL,NULL,NULL,NULL);
insert into cardinals values (IDV_TMPLPTH2,IDV_TMPLPTH3,IDV_TMPLPTH3,NULL,NULL,IDV_TMPLPTH1,IDV_TMPLPTH1,NULL,NULL);
insert into cardinals values (IDV_TMPLPTH3,NULL,IDV_TMPLPTH4,NULL,NULL,NULL,IDV_TMPLPTH2,IDV_TMPLPTH2,NULL);
insert into cardinals values (IDV_TMPLPTH4,IDV_TM1PAN,IDV_TMPLPTH5,NULL,NULL,IDV_GRNDCNT1,IDV_TMPLPTH3,NULL,NULL);
insert into cardinals values (IDV_TMPLPTH5,IDV_TMPLPTH6,NULL,NULL,NULL,IDV_TMPLPTH4,NULL,NULL,NULL);
insert into cardinals values (IDV_TMPLPTH6,IDV_TMPLPTH7,NULL,NULL,NULL,IDV_TMPLPTH5,NULL,NULL,NULL);
insert into cardinals values (IDV_TMPLPTH7,IDV_TMPLPTH8,NULL,NULL,NULL,IDV_TMPLPTH6,NULL,NULL,NULL);
insert into cardinals values (IDV_TMPLPTH8,IDV_TMPLPTH9,NULL,NULL,NULL,IDV_TMPLPTH7,NULL,NULL,NULL);
insert into cardinals values (IDV_TMPLPTH9,NULL,NULL,NULL,NULL,IDV_TMPLPTH8,NULL,NULL,NULL);
insert into cardinals values (IDV_GRNDCNT1,IDV_ctya,IDV_NAT1a,IDV_VIL2,IDV_EYEA,IDV_FA1PAN,IDV_QUARSA,IDV_SCN10PT0,NULL);
...
insert into cardinals values (IDV_WR1,IDV_WR2,NULL,NULL,NULL,IDV_GRNDCNT1,NULL,NULL,NULL);
insert into cardinals values (IDV_WR2,IDV_WR3,NULL,NULL,NULL,IDV_WR1,NULL,NULL,NULL);
insert into cardinals values (IDV_WR3,IDV_W4LOCK,NULL,NULL,NULL,IDV_WR2,NULL,NULL,NULL);
