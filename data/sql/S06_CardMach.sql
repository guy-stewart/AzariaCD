...
-- ('1660', 'S06_CYCLE_COMP1', '1568', 'IDV_CARDMACH1', '35', '75', '100', '125', '0','M06_CYCLE_VIEW','','','',''),
-- ('1661', 'S06_CYCLE_COMP2', '1568', 'IDV_CARDMACH1', '35', '75', '100', '125', '0','M06_CYCLE_VIEW','','','',''),
-- ('1662', 'S06_CYCLE_COMP3', '1568', 'IDV_CARDMACH1', '35', '75', '100', '125', '0','M06_CYCLE_VIEW','','','','');
...
('M06_CYCLE_VIEW','10', '0', 'GTEi', 'WPARM', '24', 'ASSIGN(WPARM,24);'), --missing some sprites so just go to 10 for now
('M06_CYCLE_VIEW','10', '11', 'MOV', 'WOBJECT', 'WPARM', 'MAPi(WOBJECT,S06_MAN_OBJECTS);ASHOW(WOBJECT);'),
('M06_CYCLE_VIEW','11', '0', 'Z_EPSILON', '', '', ''),

('M06_CYCLE_VIEW','20', '0', 'LTEi', 'WPARM', '0', 'ASSIGN(WPARM,0);'),
('M06_CYCLE_VIEW','20', '21', 'MOV', 'WOBJECT', 'WPARM', 'MAPi(WOBJECT,S06_MAN_OBJECTS);ASHOW(WOBJECT);'),
