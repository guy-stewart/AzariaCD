...
-- Chose to remove this area from beta 1 and replace with modified 
-- Nat1a area with racepan
-- this area is only accessible from the continent when 
-- the players have found the eye wand
...
delete from "main"."triggers" where [to] like 'IDV_NAT1%';
-- INSERT INTO "main"."triggers" ("from", "left", "top", "right", "bottom", "to", "facing") 
-- VALUES 
-- ('IDV_CONTINENT', '917', '363', '970', '430', 'IDV_NAT1A', '360');
